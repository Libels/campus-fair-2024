...
export default function UniversityTest() {
	return (
		<>
			<main className="flex lg:flex-row flex-col-reverse min-h-full w-full items-center bg-white px-8 py-24 sm:py-32 lg:px-16">
				<div className="lg:w-1/2">
					<p className="text-base font-semibold text-teal-600">UTBK</p>
					<h1 className="mt-4 text-3xl font-bold tracking-tight text-gray-900 sm:text-5xl">Belum tersedia</h1>
					<p className="mt-6 text-base leading-7 text-gray-600">Selagi layanan ini dalam maintenance, kamu bisa cek hal keren lainnya!</p>
					<div className="mt-10">
						<Link
							href="/"
