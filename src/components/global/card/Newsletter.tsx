						...
						<div className="max-w-xl lg:max-w-lg">
							...
							<div>
								<form onSubmit={handleSubmit} className="mt-6 flex max-w-md gap-x-4" action="/api/hello" method="post">
									...
									<button
										type="submit"
										className="flex-none rounded-md bg-fuchsia-500 py-2.5 px-3.5 text-sm font-semibold text-white shadow-sm hover:bg-fuchsia-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-fuchsia-500"
									>
										Subscribe
									</button>
								</form>
